...
* Sensors : Interface to view the state of sensors and configure notifications.
* Trains : Interface to control the speed and function of locomotives.

## Rules

Only guideline is to use the QWidgets framework to build UI components.
